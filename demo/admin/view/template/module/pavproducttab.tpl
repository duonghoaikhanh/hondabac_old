  ...
  <div class="box">
          ...
          <div id="tab-language-<?php echo $module_row; ?>-<?php echo $language['language_id']; ?>">
            <table class="form">
              <tr>
                ...
                <td><textarea name="pavproducttab_module[<?php echo $module_row; ?>][description][<?php echo $language['language_id']; ?>]" id="description-<?php echo $module_row; ?>-<?php echo $language['language_id']; ?>"><?php echo isset($module['description'][$language['language_id']]) ? $module['description'][$language['language_id']] : ''; ?></textarea></td>
              </tr>
            </table>
          </div>
          <?php } ?>
    ...
    <table class="form">
			<tr>
				...
				<td class="left"><input type="text" name="pavproducttab_module[<?php echo $module_row; ?>][width]" value="<?php echo $module['width']; ?>" size="3" />
                <input type="text" name="pavproducttab_module[<?php echo $module_row; ?>][height]" value="<?php echo $module['height']; ?>" size="3"/>
              </td>	
			</tr>
			<tr>
				 <td class="left"><?php echo $entry_carousel; ?></td>
				  <td class="left"><input type="text" name="pavproducttab_module[<?php echo $module_row; ?>][itemsperpage]" value="<?php echo $module['itemsperpage']; ?>" size="3" /> - 
                <input type="text" name="pavproducttab_module[<?php echo $module_row; ?>][cols]" value="<?php echo $module['cols']; ?>" size="3"/> - 
				<input type="text" name="pavproducttab_module[<?php echo $module_row; ?>][limit]" value="<?php echo $module['limit']; ?>" size="3"/>
            ...
            <tr>
              ...
              <td><select name="pavproducttab_module[<?php echo $module_row; ?>][layout_id]">
            ...
            <tr>
              ...
              <td><select name="pavproducttab_module[<?php echo $module_row; ?>][position]">
            ...
            <tr>
              ...
              <td><select name="pavproducttab_module[<?php echo $module_row; ?>][status]">
            ...
            <tr>
              ...
              <td><input type="text" name="pavproducttab_module[<?php echo $module_row; ?>][sort_order]" value="<?php echo $module['sort_order']; ?>" size="3" /></td>
            </tr>
          </table>
            ...
            <?php foreach( $module['category_tabs'] as $idx => $category ) { ?>
             <table class="form category-tab" id="category-tab-wrapper<?php echo $idx+1;?>">
                <tr>
                  ...
                  <td>
                    <select name="pavproducttab_module[<?php echo $module_row;?>][category_tabs][]">
                  ...
                  <input type="hidden" name="pavproducttab_module[<?php echo $module_row; ?>][image][]" value="<?php echo $image; ?>" id="image<?php echo $imgidx; ?>"  />
                  <br />
                 ...
                 <a onclick="image_upload('image<?php echo $imgidx; ?>', 'thumb<?php echo $imgidx; ?>');"><?php echo $text_browse; ?></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="$('#thumb<?php echo $imgidx; ?>').attr('src', '<?php echo $no_image; ?>'); $('#image<?php echo $imgidx; ?>').attr('value', '');"><?php echo $text_clear; ?></a>
                  ...
                  <td>
                      <input type="text" name="pavproducttab_module[<?php echo $module_row;?>][class][]" value="<?php echo $module['class'][$idx];?>">
                  </td>
...
<script type="text/javascript">
  ...
  function addCategoryTab( wrapper,mid ){
    ...
    var html  = '';
     ...
     html += '<select name="pavproducttab_module['+mid+'][category_tabs][]">';
     <?php foreach( $product_categories as $category){ ?>
     ...
     html += '<td>  <?php echo $this->language->get( 'entry_icon_image' );?> </td>';
      html += '<td> ';
     html += '<div class="image"><img src="<?php echo $no_image; ?>" alt="" id="thumb' + banner_row + '" /><input type="hidden" name="pavproducttab_module[' + mid + '][image][]" value="" id="image' + banner_row + '" /><br /><a onclick="image_upload(\'image' + banner_row + '\', \'thumb' + banner_row + '\');"><?php echo $text_browse; ?></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="$(\'#thumb' + banner_row + '\').attr(\'src\', \'<?php echo $no_image; ?>\'); $(\'#image' + banner_row + '\').attr(\'value\', \'\');"><?php echo $text_clear; ?></a></div>';
    
     html += ' </td>'; 
     html +=        '<td><?php echo $this->language->get("entry_addition_class");?></td>';
     html +=       '<td><input type="text" name="pavproducttab_module['+mid+'][class][]"></td>';
...
function addModule() {	
	...
	html += '          <td><textarea name="pavproducttab_module[' + module_row + '][description][<?php echo $language['language_id']; ?>]" id="description-' + module_row + '-<?php echo $language['language_id']; ?>"></textarea></td>';
	html += '        </tr>';
	html += '      </table>';
	html += '    </div>';
	<?php } ?>
	...
	html += '    <td class="left"><input type="text" name="pavproducttab_module[' + module_row + '][width]" value="202" size="3" /> <input type="text" name="pavproducttab_module[' + module_row + '][height]" value="168" size="3" /></td>';
	html += '    <tr>';
	html += '    </tr>';
	html += '      <td><?php echo $entry_carousel; ?></td>';
	html += '    <td class="left"><input type="text" name="pavproducttab_module[' + module_row + '][itemsperpage]" value="8" size="3" /> - <input type="text" name="pavproducttab_module[' + module_row + '][cols]" value="4" size="3" /> - <input type="text" name="pavproducttab_module[' + module_row + '][limit]" value="16" size="3" /></td>';
	html += '    </tr>';
	html += '    <tr>';
	html += '      <td><?php echo $entry_layout; ?></td>';
	html += '      <td><select name="pavproducttab_module[' + module_row + '][layout_id]">';
	<?php foreach ($layouts as $layout) { ?>
	...
	html += '      <td><select name="pavproducttab_module[' + module_row + '][position]">';
	<?php foreach( $positions as $pos ) { ?>
	...
	html += '      <td><select name="pavproducttab_module[' + module_row + '][status]">';
	...
	html += '      <td><input type="text" name="pavproducttab_module[' + module_row + '][sort_order]" value="" size="3" /></td>';
	html += '    </tr>';
	html += '  </table>'; 
