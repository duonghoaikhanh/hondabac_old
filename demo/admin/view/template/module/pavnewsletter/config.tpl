                      ...
                      <tr>
                        ...
                        <td>
                              <?php if (isset($general['custom_email_config'])) { ?>
                                    <input type="radio" name="pavnewsletter_config[custom_email_config]" id="custom_email_config1" value="1" checked="checked"><label for="custom_email_config1"><?php echo $text_yes; ?></label>
                                     <input type="radio" name="pavnewsletter_config[custom_email_config]" id="custom_email_config0" value="0"><label for="custom_email_config0"><?php echo $text_no; ?></label>
                                <?php } else { ?>
